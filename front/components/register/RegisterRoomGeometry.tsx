...
const RegisterRoomGeometry: React.FC = () => {
    ...
    const latitude = useSelector(state => state.registerRoom.location.latitude)
    const longitude = useSelector(state => state.registerRoom.location.longitude);
